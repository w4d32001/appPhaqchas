  ...
  return (
    <div className="h-svh bg-fondo bg-no-repeat relative bg-cover bg-center">
      ...
      <div className="relative z-10">
        ...
        <LazyLoad>
          <section id="Deportes" className="p-8 bg-blue-950">
            <h2
              data-aos="fade-up"
              className="text-center py-4 text-3xl text-white"
            >
              Deportes y juegos
            </h2>
            <div
              data-aos="fade-up"
              className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 bg-blue-950 gap-4 items-center"
            >
        ...
        <section id="Disponibilidad">
          <LazyLoad>
            <div className="py-4 px-2 bg-blue-950 flex gap-2 items-center">
        ...
        <LazyLoad>
          <section
            id="DondeEstamos"
            className="h-svh bg-blue-950 flex flex-col items-center py-14 gap-14"
          >
            <div
              data-aos="fade-up"
              className="h-auto bg-gray-600 w-full flex items-center justify-center"
            >
            ...
            >
              <div className="bg-[#10192E] text-white p-4 rounded-xl h-full flex flex-col justify-around">
                <h2 className="text-[#6893cc] text-center text-3xl">
                  Ubicación
                </h2>
                <p>
